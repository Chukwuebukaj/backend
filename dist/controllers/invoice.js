...
exports.getUserInvoices = exports.getAllInvoices = exports.deleteInvoice = exports.updateInvoice = exports.createInvoice = void 0;
...
const getUserInvoices = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const loggedInUser = req.user;
        const userId = loggedInUser === null || loggedInUser === void 0 ? void 0 : loggedInUser.id;
        const requiredInvoices = yield invoiceResolver_1.invoiceResolver.Query.invoiceById(null, userId);
        if (!requiredInvoices) {
            return res
                .status(404)
