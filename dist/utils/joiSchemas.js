...
exports.invoiceSchema = joi_1.default.object({
    ...
    installment: joi_1.default.number().required(),
    initialDeposit: joi_1.default.number().required(),
    discount: joi_1.default.number().required(),
    termsAndConditions: joi_1.default.array().items(joi_1.default.string()).required(),
});
